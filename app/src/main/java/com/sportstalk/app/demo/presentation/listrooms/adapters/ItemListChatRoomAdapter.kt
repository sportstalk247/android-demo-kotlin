...
class ItemListChatRoomAdapter(
    private val onSelectItemChatRoom: OnSelectItemChatRoom = {}
) : RecyclerView.Adapter<ItemListChatRoomAdapter.ItemListChatRoomViewHolder>() {
        ...
        if (items.isEmpty()) {
            ...
            object : AsyncTask<Void, Void, DiffUtil.DiffResult>() {
                ...
                override fun onPostExecute(diffResult: DiffUtil.DiffResult) {
                    ...
                    items = update
                    diffResult.dispatchUpdatesTo(this@ItemListChatRoomAdapter)
                }
            }
                .execute()
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemListChatRoomViewHolder =
        ItemListChatRoomViewHolder(
            ItemListChatroomBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ItemListChatRoomViewHolder, position: Int) {
    ...
    inner class ItemListChatRoomViewHolder(
        val binding: ItemListChatroomBinding
        ...
        fun bind(item: ChatRoom) {
            ...
            binding.actvRoomFansCount.text =
                context.getString(R.string.n_fans_inside, decimalFormat.format(item.inroom ?: 0L))
        }
    }
